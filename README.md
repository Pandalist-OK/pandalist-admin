...
<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">PandaList v1.0.0</h1>
...
```bash
# 克隆项目
git clone https://github.com/Pandalist-OK/pandalist-admin.git
